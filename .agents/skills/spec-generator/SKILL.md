---
name: spec-generator
description: Usa esta skill cuando yo te pida crear, redactar o revisar una especificación (spec) de una funcionalidad. Guía una entrevista de requisitos y produce un spec.md siguiendo la plantilla del equipo.
---
...
2. **Entrevista a mi.** Preguntas de **UNA en UNA**, genera el número óptimo de preguntas para cubrir los alcances y objetivos propuestos en base a los requistos y peteciones de Hugo, esperando
   ...
   ante errores y qué queda fuera. No propongas soluciones técnicas: si yo te pregunto "¿cómo lo harías?", redirige al QUÉ.|
...
Si yo te pido revisar en vez de crear, no reescribas: **detecta y lista**,
